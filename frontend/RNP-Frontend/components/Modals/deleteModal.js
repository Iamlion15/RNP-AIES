...
const DeleteOfficerModal = ({ modalIsOpen, toggleModal,data }) => {
    const handleDelete = async (e) => {
        ...
        try {
            const response = await axios.delete(`http://localhost:8000/api/case/delete/officer/${data}`, config)
      ...
      <Modal isOpen={modalIsOpen} toggle={toggleModal} className="d-flex align-items-center justify-content-center" style={{ minHeight: '100vh' }}>
        <ModalBody>
          <div className="d-flex flex-column align-items-center">
            ...
            <p className="font-monospace status-message">Are you sure you want to delete this officer?</p>
          </div>
        </ModalBody>
        <ModalFooter>
